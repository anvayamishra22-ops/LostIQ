...
const ReportFound = () => {
  ...
  return (
    <div className="form-container" style={{ maxWidth: '600px' }}>
      <h2 className="section-title" style={{ textAlign: 'center' }}>🔍 Report Found Item</h2>
      <p style={{ textAlign: 'center', color: 'var(--text-light)', marginBottom: '1.5rem' }}>
        Fill out this form to register an item you have recovered on campus
      </p>
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        <div className="form-group">
          ...
          <input
            ...
            placeholder="e.g. Silver Titan Watch, Keys with Red Fob"
            required
          />
        </div>
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            placeholder="Describe where exactly you found it, unique markings, brand, serial number if any"
            required
          />
        </div>

        <div className="form-group">
          <label htmlFor="location">Campus Location Found *</label>
          <select
            id="location"
            className="form-control"
            value={location}
